    ...
    */
    ...
    // protected $guarded = ['id'];
     protected $fillable = ['id','date','business_name','establishment_year','operation_site','ownership','owner','owner_tell_1',
        'owner_tell_2','owner_email','contact_person','contact_person_tell_1','contact_person_tell_2','contact_person_email','operation_status','assets',
         'applicant_name','applicant_tell_1','applicant_tell_2',
