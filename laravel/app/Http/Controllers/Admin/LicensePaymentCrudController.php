...
use App\Http\Requests\LicensePaymentRequest as StoreRequest;
use App\Http\Requests\LicensePaymentRequest as UpdateRequest;

class LicensePaymentCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\LicensePayment');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/licensePayment');
        $this->crud->setEntityNameStrings('license payment', 'license payments');
